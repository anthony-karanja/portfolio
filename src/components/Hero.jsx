...
import Resume from '../assets/Resume-Tony.pdf';
    ...
    <>
        <div id='hero'>
          ...
          <div className='heroImages'>
            ...
            <div id='heroIcons'>
            <a href="https://www.behance.net/anthonywangongu" target="_blank"><img src="/Behance icon (1).png" alt="behance" className='behance' /></a>
            <a href="https://dribbble.com/karanja-27" target="_blank"><img src="/Dribble icon (1).png" alt="dribble" className='dribble' /></a>
            <a href="https://github.com/anthony-karanja" target="_blank"><img src="/Github icon (1).png" alt="github" className='github' /></a>
            <a href="https://www.linkedin.com/in/anthony-wangongu-55747a308/" target="_blank"><img src="/Linkedin icon (1).png" alt="linkedin" className='linkedin' /></a>
            </div>
          </div>
        </div>
    </>
